...
class PriorityQueue {
    ...
    myInsert(value){
        ...
        while(idx > 0) {
            ...
            if (this.values[parentIndex].priority > value.priority) {
                return this
            }
    ...
    mySinkDown() {
        ...
        while(true) {
            ...
            const target = (!childR || childL?.priority > childR?.priority) ? childL : childR
            const targetIndex = (!childR || childL?.priority > childR?.priority) ? childLIdx : childRIdx
            
            console.log('---', childL, childR, target)
